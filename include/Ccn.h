...
protected:
     ...
     */
    int addToCache(const char *contentName, const char *contentPath);
    ...
    bool addFwdRule(const char *contentName, FaceType faceTp, const char *src, const char *dst,int aux);
