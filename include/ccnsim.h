...
typedef std::string  chunk_t; //representation for any chunk flying within the system. It represents a pair [name|number]
...
#define __info(f) ( Ccnr::catalog[f].info) //retrieve info about the given content
